...
-- AddForeignKey
ALTER TABLE "Article" ADD CONSTRAINT "Article_id_category_fkey" FOREIGN KEY ("id_category") REFERENCES "Category"("id_category") ON DELETE RESTRICT ON UPDATE CASCADE;
